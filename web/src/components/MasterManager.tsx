...
import { getMasters, updateMasterList } from '../lib/api';
...
type TabType = 'submitters' | 'descriptions' | 'payees';
            ...
            localItems.map((item, i) => (
              <div key={i} className="flex justify-between items-center py-2 px-3 bg-white rounded-lg border border-stone-100 shadow-sm">
                ...
                <button
                  ...
                  className="w-7 h-7 flex items-center justify-center bg-red-50 text-red-600 rounded-full hover:bg-red-100 active:scale-90 transition-all font-bold text-xs"
                  aria-label="削除"
                >
                  ✕
                </button>
